...
model.modelPath('/home/rodrigum/BrainCare/Subdermal/P4_grid');
...
HM_imp.set('filename', '/home/rodrigum/BrainCare/Subdermal/P4_grid/P4grid.mphtxt');
HM_imp.importData;
...
% 2D boundaries
bound = zeros(5,5);
bound(1,:) = [55 43 35 25 19];
bound(2,:) = [53 45 33 23 13];
bound(3,:) = [51 41 31 21 11];
bound(4,:) = [49 39 29 17  9];
bound(5,:) = [47 37 27 15  6];
...
%   CSF
csf = model.material.create('maP4');
...
ground.selection.set([31]); % The ID of the half-spherical boundary P4
