...
for j = 1:5
    ...
    if j~=3
        ...
        sol1.feature.create('S3', 'Stationary');
        sol1.feature('S3').feature.create('fc1', 'FullyCoupled');
        sol1.feature('S3').feature.create('i1', 'Iterative');
        sol1.feature('S3').feature('i1').set('linsolver', 'cg');
        sol1.feature('S3').feature('fc1').set('linsolver', 'i1');
        sol1.feature('S3').feature('i1').feature.create('mg1', 'Multigrid');
        sol1.feature('S3').feature('i1').feature('mg1').set('prefun', 'amg');
        sol1.feature('S3').feature.remove('fcDef');
        %sol1.feature('S3').set('nonlin','on');
        sol1.attach('std1');
        sol1.runAll;
