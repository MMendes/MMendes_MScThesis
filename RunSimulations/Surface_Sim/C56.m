...
for i = 20 : 21
    ...
    %if i ~= 18
        ...
        if i == 20
            ...
            C5 = struct;
            C5.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
        ...
        elseif i == 21
            ...
            C6 = struct;
            C6.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
