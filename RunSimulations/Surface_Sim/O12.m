...
EEG = struct;
% Let's test only for Fp1 and Fp2
...
for i = 9 : 10
    ...
    if i ~= 18
        ...
        if i == 1
            ...
            Fp1.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            Fp1.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
            
            save('Fp1','Fp1');
            
            model.save('Fp1_model');
            
              
        elseif i == 2
            
            Fp2 = struct;
            Fp2.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            Fp2.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
            
            save('Fp2','Fp2')
            
            model.save('Fp2_model');
            
            
        elseif i == 3
            
            F3 = struct;
            F3.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            F3.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 4
            ...
            F4 = struct;
            F4.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            F4.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 5
            ...
            C3 = struct;
            C3.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            C3.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 6
            ...
            C4 = struct;
            C4.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            C4.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 7
            ...
            P3 = struct;
            P3.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            P3.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 8
            ...
            P4 = struct;
            P4.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            P4.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 9
            ...
            O1 = struct;
            O1.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            O1.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
        ...
        elseif i == 10
            ...
            O2 = struct;
            O2.GM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',4,'edim','domain');
            O2.WM = mpheval(model,{'ec.normJ','ec.Jx', 'ec.Jy', 'ec.Jz','ec.sigmaxx'},'selection',5,'edim','domain');
