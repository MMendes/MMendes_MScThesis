...
centers(1,1,:) = [-75.5         19.4          10.3] ;
centers(1,2,:) = [-75.8         10          10] ;
centers(1,3,:) = [-73.5         0           10.2] ;
centers(1,4,:) = [-72.1        -10         10.1] ;
centers(1,5,:) = [-70.65         -20           9.75] ; % [-70.65         -20           9.75]
% % 
centers(2,1,:) = [-76.55         19.9              0.4] ;
centers(2,2,:) = [-76.3         9.8            0.4] ;
centers(2,3,:) = [-74.4         0           0.4] ;
centers(2,4,:) = [-71.35            -10.8           0] ;
centers(2,5,:) = [-69.2         -20         0] ;
% % 
% % 
centers(3,1,:) = [-76.2         20          -9] ;
centers(3,2,:) = [-75.2         10.2              -9.3] ;
centers(3,3,:) = [-74.38        0               -9.41] ;
centers(3,4,:) = [-72.1         -10             -9.4] ;
centers(3,5,:) = [-68           -20         -9.4] ;
% % 
centers(4,1,:) = [-74.7         20              -20] ;
centers(4,2,:) = [-73.15         9.65          -19.6] ;
centers(4,3,:) = [-72.25        -0.2               -19.8] ;
centers(4,4,:) = [-71.2           -9.8         -19.9] ;
centers(4,5,:) = [-67.8           -18.5         -19.8] ;
% 
% % 
centers(5,1,:) = [-73.15         19          -29.6] ;
centers(5,2,:) = [-69.5         10          -29] ;
centers(5,3,:) = [-67           0               -28.3] ;
centers(5,4,:) = [-66           -9          -29] ;
centers(5,5,:) = [-64.9         -18.7           -29] ;
...
T2 = makehgtform('zrotate',pi);
en = en * T1(1:3,1:3) * T2(1:3,1:3);
...
figure;
plotmesh(node,elem(find(elem(:,end)==6),:),'facecolor','b') % Electrodes
...
tic; mesh2comsol_v2(node, face, elem, surface_domains, 'T4grid.mphtxt'); toc_m2c = toc;
