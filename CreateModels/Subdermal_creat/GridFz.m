...
centers(1,1,:) = [-18       -65.7       63.2] ;
centers(1,2,:) = [-9        -68.7       64.6] ;
centers(1,3,:) = [0.5       -68         65.7] ;
centers(1,4,:) = [11         -68.5       64.6] ;
centers(1,5,:) = [20.3        -65.7       63.2] ;

centers(2,1,:) = [-19       -72.5       57] ;
centers(2,2,:) = [-9.3      -74.6       58.43] ;
centers(2,3,:) = [0.8       -74.8       58.8] ;
centers(2,4,:) = [11.1      -74.6       58.53] ;
centers(2,5,:) = [21        -72.8       56.4] ;

centers(3,1,:) = [-18.9     -78.8       49.7 ] ;
centers(3,2,:) = [-9.3      -81         50.9] ;
centers(3,3,:) = [0.83      -81.8       51.5] ; %%
centers(3,4,:) = [11        -81         50.8] ;
centers(3,5,:) = [21.4      -79         49.4] ;

centers(4,1,:) = [-19       -84.8       41] ;
centers(4,2,:) = [-9.3       -87.5      42] ;
centers(4,3,:) = [0.86      -88.3       42.55] ;
centers(4,4,:) = [11.7      -87         41.6] ;
centers(4,5,:) = [21        -84.8       41] ;

centers(5,1,:) = [-19.5     -89.5       33.5] ;
centers(5,2,:) = [-9.8      -91.4       33.4] ;
centers(5,3,:) = [0.4       -93         33.7] ;
centers(5,4,:) = [11.1      -91.6       33.2] ;
centers(5,5,:) = [21.15      -89.4      32.3] ;
...
T1 = makehgtform('yrotate',0*pi/2);
T2 = makehgtform('zrotate',0*pi/2);
T3 = makehgtform('xrotate',-1.2*pi/2);
...
%[n_grid,f_grid] = mergemesh(  e13_n,e13_f  );
...
tic; mesh2comsol_v2(node, face, elem, surface_domains, 'Fzgrid.mphtxt'); toc_m2c = toc;
